...
<?php $__empty_1 = true; $__currentLoopData = $recordwords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recordword): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
  <li>
    <a href="<?php echo e(action('PostsController@show', $recordword)); ?>"><?php echo e($recordword->title); ?></a>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/laravel_lessons_copy/myblog/resources/views/posts/search2.blade.php ENDPATH**/ ?>